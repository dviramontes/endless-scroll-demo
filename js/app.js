...
System.register("build/js/components/FeedItem", ["npm:react@0.12.2"], function($__export) {
  "use strict";
  var __moduleName = "build/js/components/FeedItem";
  var React,
      FeedItem;
  return {
    setters: [function(m) {
    ...
    execute: function() {
      FeedItem = React.createClass({
        ...
        render: function() {
          ...
          }, "↑"), "votes", React.createElement("span", {className: "badge"}, this.props.voteCount), React.createElement("span", {
            id: "down",
            className: "btn btn-sm btn-success"
          }, "↓")))))))));
        }
...
(function() {
  ...
  function runInContext(context) {
    ...
    function isElement(value) {
      return (value && value.nodeType === 1 && isObjectLike(value) && (lodash.support.nodeTag ? (objToString.call(value).indexOf('Element') > -1) : isHostObject(value))) || false;
    }
    if (!support.dom) {
  ...
  if (typeof define == 'function' && typeof define.amd == 'object' && define.amd) {
    root._ = _;
    System.register("github:lodash/lodash@3.5.0/lodash.src", [], false, function() {
      return _;
    });
...
System.register("build/js/components/FeedList", ["npm:react@0.12.2", "build/js/components/FeedItem"], function($__export) {
  "use strict";
  var __moduleName = "build/js/components/FeedList";
  var React,
      FeedItem,
      FeedList;
  return {
      ...
      FeedList = React.createClass({
        ...
        render: function() {
          var feedItems = this.props.items.map(function(item) {
            var unlisted = ['self', 'nsfw', 'default', ""];
            var img = '';
...
(function() {
function define(){};  define.amd = {};
System.register("github:lodash/lodash@3.5.0", ["github:lodash/lodash@3.5.0/lodash.src"], false, function(__require, __exports, __module) {
  return (function(main) {
    return main;
  }).call(this, __require('github:lodash/lodash@3.5.0/lodash.src'));
});
...
System.register("build/js/components/Feed", ["npm:react@0.12.2", "build/js/components/FeedList", "github:components/jquery@2.1.3", "github:lodash/lodash@3.5.0"], function($__export) {
  "use strict";
  var __moduleName = "build/js/components/Feed";
  var React,
      FeedList,
      $,
      _,
  ...
  return {
    ...
    execute: function() {
      ...
      Feed = React.createClass({
        ...
        fetchJSON: function() {
          var $__0 = this;
          var many = ("?limit=" + (this.props.many));
          $.getJSON(url + many).done((function(e) {
            if ($__0.isMounted()) {
              $__0.setState({items: e.data.children});
            }
          }));
        },
        handleScroll: function() {
          var scrollToButtom = $(window).scrollTop() + $(window).height() === $(document).height();
          if (scrollToButtom) {
            this.props.many += 5;
            this.fetchJSON();
          }
...
System.register("build/js/main", ["npm:react@0.12.2", "build/js/components/Feed"], function($__export) {
  "use strict";
  ...
  return {
    ...
    execute: function() {
      'use strict';
      React.render(React.createElement(Feed, {many: 5}), document.getElementById('mount'));
    }
  };
});
